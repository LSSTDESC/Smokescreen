...
## desc-0000-blinding-cx8-strategies
# Anticipated Challenges and Strategies for Mitigating Experimenter Bias in LSST DESC Cosmology Analysis

*Elisabeth Krause and others*

We identify some particular challenges wfor the LSST DESC cosmology analysis with regard to unconscious experimenter bias, and discuss possible ways to mitigate this source of systematic error based on an extensive literature search.
